	...
	<div class="col-lg-9 main-chart">
		...
		<table class="table table-hover">
	            ...
	            <table class="table table-hover">
	                  	  	  ...
	                  	  	  <h4><i class="fa fa-angle-right"></i> Order from Database</h4>
	                  	  	  <hr>
	                  	  	  ...
	                  	  	  List<OrderDetail> orderDetail = orderService.orderDetail();
...
<!--                                   <td><span class="label label-info label-mini">Due</span></td> -->
                                  <td><a href="AdminOrderController?orderId=<%=order.getOrderId()%>" style="background-color: white">
