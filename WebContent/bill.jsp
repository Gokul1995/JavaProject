<%@page import="com.ecom.serviceImpl.OrderServiceImpl"%>
<%@page import="com.ecom.service.OrderService"%>
...
<div style="">
	...
	User verifiedUser = (User)session.getAttribute("verifiedUser");
 	...
 	List<Order> generateBill = oService.generateBill();
 	
 	for(Order oder : generateBill){
...
<div style="text-align: center; padding: 25px;"> 
	<label>Product Purchased :</label> <h3> quantity  </h3>
